...
public class ReadOnlyPlayersManager {
	...
	/**
	 * Puts a player in a read-only state.
	 * If the player is already in such a state, the moderators and reasons are updated.
	 *
	...
	/**
	 * Removes a player from this read-only state. The player will no longer be locked.
	 *
